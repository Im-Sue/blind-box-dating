<?php /*a:6:{s:70:"/www/wwwroot/love.tongbayun.com/application/admin/view/user/index.html";i:1632893154;s:68:"/www/wwwroot/love.tongbayun.com/application/admin/view/tpl/base.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/head.html";i:1632893154;s:70:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/nav.html";i:1632893154;s:74:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/plugins.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/foot.html";i:1632893154;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>后台首页</title>
    ...
    <table class="table table-striped table-list table-no-bordered" id="tableList" 
        ...
        <thead>
            <tr>
                ...
                <th>账号</th>
                <th class="w-200">用户组</th>
                <th class="w-200">电子邮箱</th>
                <th class="w-200">手机号码</th>
                <th class="w-200">所属位置</th>
                <th class="w-50">状态</th>
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><?php echo htmlentities($v['province']); ?></td>
                ...
                <td>
                    ...
                    <a href="<?php echo url('pwd',array('id'=>$v['id'])); ?>" class="btn btn-primary btn-xs"><i class="fa fa-key"></i> 修改密码</a>
