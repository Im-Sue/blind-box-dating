<?php /*a:3:{s:66:"/www/wwwroot/love.tongbayun.com/template/white/cn/index/index.html";i:1633526736;s:68:"/www/wwwroot/love.tongbayun.com/template/white/cn/common/header.html";i:1633418254;s:68:"/www/wwwroot/love.tongbayun.com/template/white/cn/common/footer.html";i:1631529292;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="content">
        <div class="layui-row">
            <ul class="layui-nav">
                ...
                <li class="layui-nav-item  layui-this"><a href="javascript:;">抽个对象</a></li>
            ...
            <div class="layui-col-xs12" style="background: #0000006e;border-radius: 10px;text-align: center;padding: 5%;margin-bottom: 10px;">
                <div><?php echo $info['content']; ?></div>
            </div>


            <div class="layui-col-xs6 nav-one"  style="background: #5f91ee;margin-right: 4%;">
                <img src="/static/home/cn/image/white_03.png" class="img-bg">
                <img src="/static/home/cn/image/white_02.png" class="img-sex">
                <p style="margin: 10px;"><a href="/stay">放入男生纸条</a></p>
                <p style="margin: 10px;"><a href="/take?sex=1">抽取男生纸条</a></p>
            </div>

            <div class="layui-col-xs6 nav-one"  style="background: #ed5fbb;">
                <img src="/static/home/cn/image/white_03.png" class="img-bg">
                <img src="/static/home/cn/image/white_01.png" class="img-sex">
                <p style="margin: 10px;"><a href="/stay?sex=1">放入女生纸条</a></p>
                <p style="margin: 10px;"><a href="/take?sex=2">抽取女生纸条</a></p>
            </div>
            ...
            <div class="layui-col-xs12">
                ...
                <!-- 跑马灯结束 -->
                <hr>
                <div style="text-align: center;color: #000;padding: 0px 0px 10px 0px;font-size: 14px;font-weight: bolder">
                    <p>请阅读<a href="../news/919">网站条款</a> | <a href="https://beian.miit.gov.cn/"><?php echo htmlentities($siteinfo['icp']); ?></a></p>
                </div>
            </div>
        </div>
    </div>
