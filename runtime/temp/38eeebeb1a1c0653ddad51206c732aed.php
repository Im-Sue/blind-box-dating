<?php /*a:6:{s:70:"/www/wwwroot/love.tongbayun.com/application/admin/view/news/addwx.html";i:1632893154;s:72:"/www/wwwroot/love.tongbayun.com/application/admin/view/tpl/base-add.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/head.html";i:1632893154;s:68:"/www/wwwroot/love.tongbayun.com/application/admin/view/news/nav.html";i:1632893154;s:74:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/plugins.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/foot.html";i:1632893154;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>后台首页</title>
        ...
        <table class="table table-bordered table-hover table-data" id="tableData">
            <tbody>
                <tr>
                    <th>分类</th>
                    <td>
                        <select name="category_id" class="form-control w-md">
                            ...
                            <?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): $i = 0; $__LIST__ = $category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($v['id']); ?>"><?php echo htmlentities($v['cate_name_cn']); ?></option>
                ...
                <tr>
                    <th>微信文章URL</th>
                    <td><input class="form-control w-lg" type="text" name="url" placeholder="http://" /></td>
                </tr>
            </tbody>
        </table>
