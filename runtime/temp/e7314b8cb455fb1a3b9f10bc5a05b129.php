<?php /*a:6:{s:72:"/www/wwwroot/love.tongbayun.com/application/admin/view/banner/index.html";i:1632893154;s:68:"/www/wwwroot/love.tongbayun.com/application/admin/view/tpl/base.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/head.html";i:1632893154;s:70:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/nav.html";i:1632893154;s:74:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/plugins.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/foot.html";i:1632893154;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>后台首页</title>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="position_id">
                ...
                <?php if(is_array($position_list) || $position_list instanceof \think\Collection || $position_list instanceof \think\Paginator): $i = 0; $__LIST__ = $position_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo htmlentities($v['id']); ?>" <?php if($opts['position_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['position_name']); ?></option>
...
<!--                <th class="w-120">开始时间</th>
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><?php echo htmlentities($v['position']['position_name']); ?></td>
                <td><?php echo htmlentities($v['title']); ?></td>
                <td><img src="<?php echo htmlentities($v['image']); ?>" alt="" height="50px"></td>
                <td><?php echo htmlentities($v['link']); ?></td>
<!--                <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($v['start_time'])? strtotime($v['start_time']) : $v['start_time'])); ?></td>
                <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($v['end_time'])? strtotime($v['end_time']) : $v['end_time'])); ?></td>-->
