<?php /*a:6:{s:74:"/www/wwwroot/love.tongbayun.com/application/admin/view/siteinfo/index.html";i:1633531198;s:68:"/www/wwwroot/love.tongbayun.com/application/admin/view/tpl/base.html";i:1633531198;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/head.html";i:1633531198;s:70:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/nav.html";i:1633531198;s:74:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/plugins.html";i:1633531198;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/foot.html";i:1633531198;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>后台首页</title>
...
<div class="wrapper">
    ...
    <form class="well search-form form-inline" action="" method="get">
        <div class="form-group">
            关键词：<input class="form-control" type="text" name="kw"  value="<?php echo htmlentities((isset($opts['kw']) && ($opts['kw'] !== '')?$opts['kw']:'')); ?>" />
        </div>
    ...
    <table class="table table-striped table-list table-no-bordered" id="tableList" 
        ...
        <thead>
            <tr>
                ...
                <th class="w-200">标题</th>
                <th class="w-200">配置代码</th>
                <th>配置值</th>
                <th class="w-50">状态</th>
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><?php echo htmlentities($v['config_name']); ?></td>
                <td><?php echo htmlentities($v['config_value']); ?></td>
