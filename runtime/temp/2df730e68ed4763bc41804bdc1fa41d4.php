<?php /*a:6:{s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/banner/edit.html";i:1632893154;s:73:"/www/wwwroot/love.tongbayun.com/application/admin/view/tpl/base-edit.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/head.html";i:1632893154;s:70:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/nav.html";i:1632893154;s:74:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/plugins.html";i:1632893154;s:71:"/www/wwwroot/love.tongbayun.com/application/admin/view/public/foot.html";i:1632893154;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>后台首页</title>
...
<div class="wrapper">
    ...
    <table class="table table-bordered table-hover table-data" id="tableData">
        <tbody>
                ...
                <td>
                    <select name="data[position_id]" class="form-control w-md">
                        ...
                        <?php if(is_array($position_list) || $position_list instanceof \think\Collection || $position_list instanceof \think\Paginator): $i = 0; $__LIST__ = $position_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo htmlentities($v['id']); ?>" <?php if($data['position_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['position_name']); ?></option>
            ...
            <tr>
                <th>标题</th>
                <td><input class="form-control w-lg" type="text" name="data[title]" value="<?php echo htmlentities($data['title']); ?>" /></td>
            </tr>
            <tr>
                <th>副标题</th>
                <td><input class="form-control w-lg" type="text" name="data[sub_title]" value="<?php echo htmlentities($data['sub_title']); ?>"/></td>
            </tr>
            <tr>
                <th>链接</th>
                <td><input class="form-control w-lg" type="text" name="data[link]" value="<?php echo htmlentities($data['link']); ?>" placeholder="http://" /></td>
            </tr>
            <tr>
                <th>内容</th>
                <td>
                    <textarea name="data[brief]" class="form-control w-lg" rows="4"><?php echo htmlentities($data['brief']); ?></textarea>
                </td>
            </tr>
            <tr>
                <th>图片</th>
                <td>
                    ...
                    <div id="imageDisplay">
                        <input type="hidden" name="data[image]" value="<?php echo htmlentities($data['image']); ?>" class="js-file-input" />
                        ...
                        <?php else: ?>
                        <img class="data-img js-img" data-default="/static/admin/images/thumbnail.png" src="<?php echo htmlentities($data['image']); ?>" />
                        <?php endif; ?>
