$(function () {
    ...
    layui.use(['form','layer'], function () {
        ...
        $("#invitation").click(function () {
            layer.prompt({title:'推广登录'},function(value){
                var pwd = $("#pwd").val();
                $.ajax({
                    url: '/invitation/login',
                    type: 'post',
                    data: {user:value,pwd:pwd},
                    dataType: "json",
            ...
            $(".layui-layer-content .layui-layer-input").attr("placeholder","输入账号");
            $(".layui-layer-content").append("<br><input type=\"password\" id= \"pwd\" class=\"layui-input\" placeholder=\"请输入密码\"/>");
            $(".layui-layer-content").append("<div style='text-align: center;margin: 10px 0px;'><b>无需注册，直接登陆(自动生成账号)</b></div>");
        });
