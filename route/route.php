...
$homeRoute = function(){
    ...
    Route::group("invitation",function (){
        Route::get('', 'home/Invitation/index');
        Route::get('order', 'home/Invitation/order');
        Route::post('login', 'home/Invitation/login');
        Route::get('login_out', 'home/Invitation/login_out');
        Route::post('tixian', 'home/Invitation/tixian');
        Route::post('tixianjilu', 'home/Invitation/tixianjilu');
    });
